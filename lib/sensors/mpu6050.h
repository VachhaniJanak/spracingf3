...
void MPU6050_Read_Accel(void)
{
  ...
  int Ax = (Accel_X_RAW / 16384.0) * 100;
  int Ay = (Accel_Y_RAW / 16384.0) * 100;
  int Az = (Accel_Z_RAW / 16384.0) * 100;
...
void MPU6050_Read_Gyro(void)
{
  ...
  int Gx = (int)(Gyro_X_RAW / 131.0) * 100;
  int Gy = (int)(Gyro_Y_RAW / 131.0) * 100;
  int Gz = (int)(Gyro_Z_RAW / 131.0) * 100;
